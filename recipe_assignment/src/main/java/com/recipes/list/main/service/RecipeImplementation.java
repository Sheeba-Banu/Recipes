...
import com.recipes.list.main.controller.UtilityClass;
import com.recipes.list.main.entity.Recipes;
import com.recipes.list.main.exception.RecordNotFoundException;
import com.recipes.list.main.model.RecipeModelClass;
import com.recipes.list.main.repository.RecipesRepository;
...
public class RecipeImplementation implements RecipeInterface {
	...
	*/
	@Override
	@Transactional
	public RecipeModelClass getRecipe(int id) throws RecordNotFoundException {
